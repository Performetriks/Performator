 ...
 * 
 ***************************************************************************/
public class PFRExecRepeat extends PFRExec {
	
	private static Logger logger = (Logger) LoggerFactory.getLogger(PFRExecRepeat.class.getName());
	 ...
	 * 
	 ***************************************************************************/
	public PFRExecRepeat(Class<? extends PFRUsecase> usecase, int repetitions, long offset){

		this(usecase, repetitions);
	 ...
	 *****************************************************************/
	public PFRExecRepeat offset(int offsetSeconds) {
	...
	public void initialize() {
		...
		synchronized(logger) {
			...
			logger.info("Repetitions: " + this.repetitions);
	...
	public void getSettings(JsonObject settings) {
		settings.addProperty("repetitions", repetitions);
